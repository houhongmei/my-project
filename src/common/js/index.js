...
layui.config({
    // base: '../js/',
    base: 'src/common/js/',
    version: new Date().getTime()}).use(['element', 'layer', 'navbar', 'tab'], function () {
    ...
    navbar.on('click(side)', function (data) {
        if(data.field.href.indexOf("jsp")!=-1&&data.field.href.indexOf("?old")==-1){
            data.field.href="!RunBack/~/pages/includeBody.jsp?url="+encodeURIComponent($.base64.encode(data.field.href));
        }
